...
export class PanierPage implements OnInit {
  ...
  selectedValue!: any;
  ngOnInit() {
    this.livraisonDate.setDate(
      this.livraisonDate.getDate() + this.delai_de_livraison
    );
  ...
  onPointRelaisChange(event: any) {
    ...
    this.pointsRelais.forEach((pt) => {
      if (pt.nom == selectedPointNom) {
        this.pointchoisi = pt;
      }
    });
